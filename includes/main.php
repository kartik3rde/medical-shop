...
?>
          ...
          <a class="currency__change" style="margin-left:10px" href="admin_area/login.php">Admin Login</a>
        </div>
      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="index.php">
             <img class="logo__img" src="images/logo.png" alt="" width="237" height="19">
          </a>
        </div>
