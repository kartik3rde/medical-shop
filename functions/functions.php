...
$get_items = "select * from cart where ip_add='$ip_add'";
 ...
 if(isset($_SESSION['customer_email'])){
     $userEmail=$_SESSION['customer_email'];
         $get_items = "select * from cart where uId='$userEmail' ";
 }
...
<img src='admin_area/product_images/$pro_img1' style='height:200px' class='img-responsive' >
...
<p class='btn btn-primary btn-xs'> $manufacturer_name </p>
...
<img src='admin_area/product_images/$pro_img1' class='img-responsive' style='height: 190px;'>
